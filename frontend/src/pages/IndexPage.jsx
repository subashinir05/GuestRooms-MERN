...
export default function IndexPage() {
  ...
  return (
        <div>
      <div className="font-serif mt-10 grid gap-6 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          {/* Places in home page */}
        {places.length > 0 && places.map(place => (
        <Link to={'/place/' + place._id} key={place._id} className="bg-white rounded-lg shadow-md overflow-hidden">
